...
public class TestUnitaireRationnelSimple {
  ...
  public void test_Constructeur2() {
    ...
    Rationnel r2 = new RationnelSimple(6, 2);
  ...
  public void testEqualsRationnel() {
    ...
    Rationnel r3 = new RationnelSimple(3);
  ...
  public void testInverseEchecAssert() {
    ...
    Rationnel zero = new RationnelSimple(0);
  ...
  public void inserer_tableau_vide() {
    ...
    // insertion dans un tableau vide
    Rationnel [] resu = new Rationnel[]{new RationnelSimple(1, 2)};
  ...
  public void inserer_tete_tableau_1elt() {
    ...
    lesRationnels[0] = new RationnelSimple(1, 2);
    clientRationnel.insererRationnel(new RationnelSimple(1, 3), lesRationnels, 1);
  ...
  public void inserer_fin_tableau_1elt() {
    ...
    Rationnel [] lesRationnels = new Rationnel[2];
    lesRationnels[0] = new RationnelSimple(1, 3);
    clientRationnel.insererRationnel(new RationnelSimple(1, 2), lesRationnels, 1);
    tester_egalite(lesRationnels, resu, 2);
  ...
  public void inserer_tete() {
    ...
    for (int i = 0; i < numerateurs.length; ++i) {
      clientRationnel.insererRationnel(new RationnelSimple(numerateurs[i], denominateurs[i]),
				       lesRationnels, i);
    }
